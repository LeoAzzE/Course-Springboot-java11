package com.stududing.course.config;
...
import com.stududing.course.entities.Payment;
import com.stududing.course.entities.Product;
import com.stududing.course.entities.User;
import com.stududing.course.entities.enums.OrderStatus;
import com.stududing.course.repositories.CategoryRepository;
import com.stududing.course.repositories.OrderItemRepository;
...
@Configuration
@Profile("test")
public class TestConfig implements CommandLineRunner { // para executar
	@Autowired // o Spring vai fazer a associação e instanciar uma dependencia de usar repository
	...
	public void run(String... args) throws Exception {
			...
			userRepository.saveAll(Arrays.asList(u1, u2)); // criando uma lista e salvando as instâncias no banco
